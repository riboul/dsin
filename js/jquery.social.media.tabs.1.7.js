...
(function($){
	...
	$.extend(SocialTabsObject.prototype, {
		...
		create: function(el, options) {
			...
			if(this.o.method == 'slide'){
				...
				/***/
				/* NCHO don't care => always use slide method
				/***/
				this.dcstatic($a,$t,$l);
			}
		...
		slickTabs: function(i,a,t,s){
			/***/
			/* NCHO je ne sais pas encore a quoi ça sert
			/***/
			var self = this;
		...
		/***/
		/* NCHO pour la partie slider il faut la recuperer a partir de nos classes css
		/***/
	...
	function createWidget(obj,type,id,o,w,h,share,tweetId){
		/***/
		/* NCHO ici on crée le contenu d'un tab
		/***/
				...
				if(error == ''){
					$.each(a, function(i,item){
						if(i < o.limit){
							...
							/***/
							/* NCHO share a false si on ne veut pas les liens pour chaque tweet
							/***/
							if(share == true){
